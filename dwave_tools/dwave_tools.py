...
from dwave.inspector import show, show_bqm_response, show_bqm_sampleset, show_qmi
...
def get_dwave_solution(annealer_solution, total_num_qubits, QM, num_reads=500, chain_strength=100, annealing_time_us=20):
